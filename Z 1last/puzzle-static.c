...
int No_of_Columns(char s[100][100]); // fuction for getting number of column of grid.
int check_grid(); // check for invalid input.
...
word_space array[100]; // to get horizontal spaces
word_space array_v[100];// to get vertical spaces
word_space combined_array[100]; // combined

int used_word_bool[100] = { };  // Relavent index of this array will be one if word is used.
char puzzle_array[100][100];    //2D array that stores puzzle
char word_list[100][20];        //2D array that stores words
int rows = 0, num_of_words = 0; //rows-> no of rows in puzzle grid, num_of_words-> no of words given
...
int main(){
    ...
    int tempc=check_grid(); // Check grid for invalid inputs
    if(tempc==1){
        printf("INVALID INPUT\n");
        return 0;
    }
// --------------------------------------------------------------
    int word_space_array_count = 0; // Find  horizontal spaces.
...
// -------------------------------------------------------------------------------------------------------------------- 
    int word_space_array_count_v = 0; // Find  vertical spaces.
...
int No_of_Columns(char s[100][100]){    //function to return column number in puzzle grid
    int columns=0;
...
int check_grid(){   //function to check  wether the given puzzle is valid or not
    int c_=0;
