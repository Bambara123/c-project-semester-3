...
#define word_array_size 24
#define puzzle_row 10
#define puzzle_colo 11
...
int main(){
    ...
    char word_list[word_array_size][20] = {"moka","kell","pen","win","gl","long","ow","stolet","wedding","le","ree","ke","ant","set","elsetk","toesn","ada","netpce","lc","dn","ithree","race","halleg","aa"};


    char puzzle_array[puzzle_row][puzzle_colo] = {"m#k#*****##", "*#######**#","***###****n","#****######","#****####**","######*****","**#**####tk","###****#**#","**######**#","#i#*******#"};
