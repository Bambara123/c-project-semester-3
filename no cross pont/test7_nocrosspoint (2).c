...
// -------------------------------------------------------------------------------------------------------------------- vertical
    ...
    for(int x = 0; x < c_a_count; x++){ //  fill horizontally.

        if(combined_array[x].direction == 'h'){
        ...
        if(combined_array[x].direction == 'v'){ // fill vertically.
            ...
            for(int y = 0; y < 4; y++){ // 4 = length of the word list.
                ...
                if(word_filled_ind == combined_array[x].word_fill_count){ // check whether word_fill_count is equal to number of iterations.

                    if(strlen(word_list[y]) == combined_array[x].length && used_word_bool[y] == 0){

                        printf("v_word: %s", word_list[y]);
