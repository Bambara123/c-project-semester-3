...
int used_word_bool[100] = { };  // Relevant index of this array will be one if word is used.
...
int main(){
    ...
    char **word_list = malloc(sizeof(char *) * 20);  // To get the words.
    char temp;
    int impossible = 0;

    puzzle_array[puzzle_row] = malloc(sizeof(char *) * 100);
